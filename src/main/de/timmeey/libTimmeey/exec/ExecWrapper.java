...
//			}
	...
	public ExecResultWrapper exec(final String command) throws ExecuteException, IOException {
		PipedOutputStream stdOut = new PipedOutputStream();
		PipedOutputStream stdErr = new PipedOutputStream();
		CollectingOutputStream outputStream = new CollectingOutputStream(stdOut);
		CollectingOutputStream errorStream = new CollectingOutputStream(stdErr);
		CommandLine commandline = CommandLine.parse(command);
		DefaultExecutor exec = new DefaultExecutor();
		DefaultOwnExecuteResultHandler resultHandler = new DefaultOwnExecuteResultHandler();
