...
public interface ObjectPool<K, V> {
	 ...
	 * @throws Exception
	 */
    V borrow(K key, Callable<V> callable) throws Exception;
	 ...
	 * @return
	 */
    ObjectPool store(K key, V objectToPool);
	 ...
	 * @return
	 */
    ObjectPool giveBack(V borrowedObjeced);
	 ...
	 * @return
	 */
    ObjectPool giveBackWithoutIdleTimeReset(V borrowedObject);
	 ...
	 * @return
	 */
    ObjectPool removeByObject(V object);
